...
int main()
{
    ...
    //try {
        ...
        //{
        //    std::cout << "Press Enter to move up 50 meters in z direction with 5 m/s velocity\n";
        //    std::cin.get();
        //    auto position1 = client.getMultirotorState().getPosition(); // from current location
        //    client.moveToPositionAsync(position1.x(), position1.y(), position1.z() - 50, 5)->waitOnLastTask();
        //
        //    auto barometer_data = client.getBarometerData();
        //    std::cout << "Barometer data \n"
        //              << "barometer_data.time_stamp \t" << barometer_data.time_stamp << std::endl
        ...
        //
        //std::cout << "Press Enter to fly in a 150m box pattern at 10 m/s velocity" << std::endl;
        //std::cin.get();
        //{
        //    auto position = client.getMultirotorState().getPosition();
        //    float z = position.z(); // current position (NED coordinate system).
        //    constexpr float speed = 10.0f;
        //    constexpr float size = 150.0f;
        //    constexpr float duration = size / speed;
        //    DrivetrainType drivetrain = DrivetrainType::ForwardOnly;
        //    YawMode yaw_mode(true, 0);
        ...
        //    std::cout << "Press Enter to move down 50 meters in z direction with 5 m/s velocity\n";
        //    std::cin.get();
        //    auto position1 = client.getMultirotorState().getPosition(); // from current location
        //    client.moveToPositionAsync(position1.x(), position1.y(), position1.z() + 50, 5)->waitOnLastTask();
        //}
